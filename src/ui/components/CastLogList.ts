...
export class CastLogList {
  ...
  private rows: CastLogRow[] = [];
  private rowsById: Map<string, CastLogRow> = new Map();
  private isEmptyView = false;

  constructor(container: HTMLElement, private openLink: (path: string) => void) {
