 ...
 * Intentionally re-declared here (not imported from castLog/) so cast/ owns its port interface.
 */
...
/**
 * Port: records cast result events (success/failure).
 * cast/ owns this port; implementations live in castLog/ or elsewhere.
 */
